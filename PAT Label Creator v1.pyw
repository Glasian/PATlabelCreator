...
def createPassSheet():
    ...
    if checkCorrect(startNo,endNo,month,companyName,custName):
        def draw_label(label, width, height, obj):
            label.add(shapes.String(width/2, 60, "Portable Appliance Test", textAnchor="middle",fontName="Helvetica-Bold", fontSize=9,fillColor="green"))
            ...
            label.add(shapes.String(4, 40, "I.D.: "+str(obj), fontName="Helvetica", fontSize=12,fillColor="green"))
            label.add(shapes.String(4, 29, "Tested: "+month+" "+str(year), fontName="Helvetica", fontSize=10,fillColor="green"))
        ...
        specs = labels.Specification(296, 209, 7, 7, 38, 25, corner_radius=1,left_margin=9,right_margin=9,top_margin=11,bottom_margin=11,column_gap=2,row_gap=2)
...
def createFailSheet():
    ...
    if companyCorrect(companyName):
        def draw_label(label, width, height, obj):
            ...
            r.strokeColor = None
            label.add(r)
            label.add(shapes.String(width/2, 60, "Portable Appliance Test", textAnchor="middle",fontName="Helvetica-Bold", fontSize=9))
